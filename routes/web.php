...
Route::group([
    ...
    Route::post('/delete/{item}', ["uses" => '\App\Http\Controllers\ProfileController@destroy', "as" => "delete"]);
});
...
Route::group([
    ...
    Route::post('/delete/{item}', ["uses" => '\App\Http\Controllers\EducationLevelController@destroy', "as" => "delete"]);
});
